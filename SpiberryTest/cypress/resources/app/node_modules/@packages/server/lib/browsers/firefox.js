...
async function open(browser, url, options = {}, automation) {
    ...
    const [foxdriverPort, marionettePort,] = await bluebird_1.default.all([(0, get_port_1.default)(), (0, get_port_1.default)()]);
    ...
    const [cacheDir, extensionDest, launchOptions,] = await bluebird_1.default.all([
    ...
    const browserInstance = await (0, browsers_1.launch)(browser, 'about:blank', remotePort, launchOptions.args, {
