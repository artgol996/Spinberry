...
const getUrl = function (type, port) {
    switch (type) {
        case 'INDEX':
            return (0, resolve_dist_1.getPathToDesktopIndex)(port);
        default:
...
function open(projectRoot, launchpadPort, options = {}, newBrowserWindow = _newBrowserWindow) {
